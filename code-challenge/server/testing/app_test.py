...
class TestApp:
    ...
    def test_restaurants(self):
        ...
        with app.app_context():
            ...
            for restaurant in response:
                assert 'restaurant_pizzas' not in restaurant  # Ensure this is correct
    ...
    def test_restaurants_id(self):
        ...
        with app.app_context():
            ...
            assert 'restaurant_pizzas' not in response  # This should be not in response
    ...
    def test_returns_404_if_no_restaurant_to_delete(self):
        ...
        with app.app_context():
            response = app.test_client().delete('/restaurants/0')  # Change this to delete
            assert response.status_code == 404
    ...
    def test_pizzas(self):
        ...
        with app.app_context():
            ...
            for pizza in response:
                assert 'restaurant_pizzas' not in pizza  # Ensure this is correct
    ...
    def test_creates_restaurant_pizzas(self):
        ...
        with app.app_context():
            ...
            assert response['id']
            assert response['pizza']  # Ensure this is valid
            assert response['restaurant']  # Ensure this is valid
